...
google_sheets.py     — модуль работы с Google Sheets (добавление товаров, менеджеры, дедупликация)
...
- Bot API через aiohttp, функции: `send_telegram()`, `pin_telegram_message()`
...
- Цвета: красный = ARG в названии, зелёный = артикул не на 30000*
